function [outputImage, colorfulLabels] = VideoGraphCutTexturesFountain
...
%  Reading a Video!
% -------------------
patchFile = VideoReader('in/fountain_original.mpg'); % 224x240. 300 Frames
